(function(){
  ...
  function initCanvas(initialCanvas){
    ...
    function qualityRatio(profile){
      ...
      const cap=profile.compact?(profile.high?2.50:(profile.low?1.50:2.16)):(profile.tablet?(profile.high?2.32:2.08):(profile.high?2.22:2.02));
      const budget=profile.compact?(profile.high?3800000:(profile.low?1350000:2750000)):(profile.tablet?(profile.high?4700000:3500000):(profile.high?6100000:4550000));
    ...
    function initialize(){
      ...
      if(Q)Q.configureRenderer(renderer,{exposure:1.16,pixelCap:qualityRatio(profile)});
      else{
    ...
    window.ByMeliServiceV25=window.ByMeliServiceV25||{};
    window.ByMeliServiceV24=window.ByMeliServiceV25;
    window.ByMeliServiceV20=window.ByMeliServiceV25;
    window.ByMeliServiceV25[type]={
