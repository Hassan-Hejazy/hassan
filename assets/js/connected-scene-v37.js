(function(){
  ...
  function qualityTargets(p){
    ...
    if(p.compact){
      cap=p.high?3.80:(p.low?1.95:3.00);
      targetWidth=p.landscape?3840:2160;
      targetHeight=p.landscape?2160:3840;
      ultraPixels=p.high?9200000:(p.low?3000000:5800000);
      motionPixels=p.high?5000000:(p.low?1650000:3000000);
      minRatio=p.low?1.28:1.85;
    }else if(p.tablet){
      cap=p.high?3.50:(p.low?2.00:3.05);
      targetWidth=3840;targetHeight=2160;
      ultraPixels=p.high?9800000:(p.low?3900000:7100000);
      motionPixels=p.high?6200000:(p.low?2500000:4300000);
      minRatio=p.low?1.36:1.88;
    }else{
      cap=p.high?3.40:(p.low?2.05:3.10);
      targetWidth=3840;targetHeight=2160;
      ultraPixels=p.high?10800000:(p.low?4500000:8200000);
      motionPixels=p.high?7600000:(p.low?3100000:5600000);
      minRatio=p.low?1.42:1.95;
    }
  ...
  function buildIntegratedWorld(){
    ...
    const routeGlow=new THREE.Mesh(new THREE.TubeGeometry(journeyRoute,profile.low?100:220,.085,8,false),new THREE.MeshBasicMaterial({color:0x69cdbb,transparent:true,opacity:.06,depthWrite:false,toneMapped:false,blending:THREE.AdditiveBlending}));integratedWorld.add(routeGlow);worldRings.push(routeGlow);
    const routeCore=new THREE.Mesh(new THREE.TubeGeometry(journeyRoute,profile.low?100:220,.018,6,false),new THREE.MeshBasicMaterial({color:0xe7c36e,transparent:true,opacity:.42,depthWrite:false,toneMapped:false}));integratedWorld.add(routeCore);worldRings.push(routeCore);
    ...
    for(let x=minX+2;x<maxX-1;x+=3.25){const cross=new THREE.Mesh(new THREE.BoxGeometry(.10,.10,ceilingZ*2.02),bronze);cross.position.set(x,6.18,0);integratedWorld.add(cross);worldFrames.push(cross);const lamp=new THREE.PointLight(0xffe0a8,profile.compact?.16:.26,8,2);lamp.position.set(x,5.9,3.75);integratedWorld.add(lamp);worldBeacons.push(lamp);}
  }
  ...
  window.ByMeliConnectedV37={forceInit:queueInit,dispose:()=>disposeConnected(true),auditAt,renderAt,getState:()=>({initialized,progress,target:targetProgress,state:timeline(progress),profile:profile?{w:profile.w,h:profile.h,tier:profile.tier,pixelRatio:renderRatio,ultraRatio:maxRenderRatio,motionRatio:motionRenderRatio,qualityState}:null})};
  window.ByMeliConnectedV36=window.ByMeliConnectedV37;
  window.ByMeliConnectedV35=window.ByMeliConnectedV37;
  window.ByMeliConnectedV34=window.ByMeliConnectedV37;
  window.ByMeliConnectedV33=window.ByMeliConnectedV37;
  window.ByMeliConnectedV32=window.ByMeliConnectedV37;
  window.ByMeliConnectedV31=window.ByMeliConnectedV37;
  window.ByMeliConnectedV30=window.ByMeliConnectedV37;
  window.ByMeliConnectedV29=window.ByMeliConnectedV37;
  window.ByMeliConnectedV28=window.ByMeliConnectedV37;
  window.ByMeliConnectedV27=window.ByMeliConnectedV37;
  window.ByMeliConnectedV26=window.ByMeliConnectedV37;
  window.ByMeliConnectedV25=window.ByMeliConnectedV37;
  window.ByMeliConnectedV24=window.ByMeliConnectedV37;
  window.ByMeliConnectedV20=window.ByMeliConnectedV37;
