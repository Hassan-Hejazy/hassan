(function(){
  ...
  function qualityTargets(p){
    ...
    if(p.compact){
      ...
      motionPixels=p.high?2050000:(p.low?920000:1500000);
      ultraPixels=p.high?5600000:(p.low?2050000:3900000);
      motionCap=p.high?2.28:(p.low?1.48:1.95);
      ultraCap=p.high?3.05:(p.low?1.92:2.62);
      minRatio=p.low?1.10:1.38;
    }else if(p.tablet){
  ...
  function configureOverview(){
    if(profile.compact&&profile.portrait){
      overviewPositions=[
        new THREE.Vector3(-3.35,0,5.55),new THREE.Vector3(3.35,0,5.55),
        new THREE.Vector3(-3.35,0,0),new THREE.Vector3(3.35,0,0),
        new THREE.Vector3(-3.35,0,-5.55),new THREE.Vector3(3.35,0,-5.55)
      ];
    }else if(profile.tablet||profile.w<1250){
      overviewPositions=[
        new THREE.Vector3(-4.00,0,5.20),new THREE.Vector3(4.00,0,5.20),
        new THREE.Vector3(-4.00,0,0),new THREE.Vector3(4.00,0,0),
        new THREE.Vector3(-4.00,0,-5.20),new THREE.Vector3(4.00,0,-5.20)
      ];
    }else{
      overviewPositions=[
        new THREE.Vector3(-5.60,0,4.10),new THREE.Vector3(0,0,4.45),new THREE.Vector3(5.60,0,4.10),
        new THREE.Vector3(-5.60,0,-4.10),new THREE.Vector3(0,0,-4.45),new THREE.Vector3(5.60,0,-4.10)
      ];
    }
    updateOverviewLinks();
  ...
  function stageComposition(i){ const p=stagePreset(i);return {x:0,y:p.compY+(profile.compact?(profile.portrait?-.085:-.045):.025)}; }
  ...
  function holdPose(i,u){
    ...
    const orbit=profile.compact?.010:.018;
    ...
    const pose=framedPose(box,yaw,elev,profile.fov,profile.compact?.008:.011,stageComposition(i),focus);
  ...
  function finalOverviewScale(){
    if(profile.compact&&profile.portrait)return .42;
    if(profile.compact)return .45;
    if(profile.tablet||profile.w<1250)return .46;
    return .52;
  }
  ...
  function finalOverviewPose(){
    ...
    stations.forEach((_,i)=>union.union(transformedBox(i,overviewCenter.clone().add(overviewPositions[i]),scale,false,SERVICE_RELATIVE_YAW[i]*.72)));
    const yaw=portrait?0.0:(twoColumn?.025:.12);
    const elev=portrait?.76:(twoColumn?.62:(profile.compact?.54:.48));
    const fov=portrait?(profile.fov+2.8):(twoColumn?(profile.fov+1.6):(profile.fov+.4));
    return framedPose(union,yaw,elev,fov,portrait?.020:(twoColumn?.024:.020),{x:0,y:portrait?.02:.010});
  }
  ...
  function finalPlacement(i,q){
    ...
    const start=overviewCenter.clone().add(overviewPositions[i].clone().multiplyScalar(profile.compact?.52:.56));start.y+=.12;
    ...
    if(state.mode==='hold'){
      ...
      if(state.q>.20){
        stations.forEach((s,i)=>{
          ...
          const overviewYaw=SERVICE_RELATIVE_YAW[i]*.72;
  ...
  function render(now){
    ...
    // V43 uses exact scroll-to-frame mapping. Native touch inertia already
    // supplies continuous motion; removing a second easing layer prevents the
    // connected camera from lagging behind the finger on mobile.
  ...
  function queueInit(){
    ...
    setTimeout(()=>{
      ...
      try{init();}
        ...
        console.error('[By Meli] Connected V44 failed:',error);
  ...
  window.ByMeliConnectedV44={forceInit:queueInit,dispose:()=>disposeConnected(true),auditAt,renderAt,getState:()=>({initialized,progress,target:targetProgress,state:timeline(progress),startupMs:initReadyAt&&initStartedAt?initReadyAt-initStartedAt:null,visible,rafActive:Boolean(rafId),pageVisible,profile:profile?{w:profile.w,h:profile.h,tier:profile.tier,pixelRatio:renderRatio,ultraRatio:maxRenderRatio,motionRatio:motionRenderRatio,qualityState}:null})};
  window.ByMeliConnectedV43=window.ByMeliConnectedV44;
  window.ByMeliConnectedV42=window.ByMeliConnectedV44;
  window.ByMeliConnectedV41=window.ByMeliConnectedV44;
  window.ByMeliConnectedV40=window.ByMeliConnectedV44;
  window.ByMeliConnectedV39=window.ByMeliConnectedV44;
  window.ByMeliConnectedV38=window.ByMeliConnectedV44;
  window.ByMeliConnectedV37=window.ByMeliConnectedV44;
  window.ByMeliConnectedV36=window.ByMeliConnectedV44;
  window.ByMeliConnectedV35=window.ByMeliConnectedV44;
  window.ByMeliConnectedV34=window.ByMeliConnectedV44;
  window.ByMeliConnectedV33=window.ByMeliConnectedV44;
  window.ByMeliConnectedV32=window.ByMeliConnectedV44;
  window.ByMeliConnectedV31=window.ByMeliConnectedV44;
  window.ByMeliConnectedV30=window.ByMeliConnectedV44;
  window.ByMeliConnectedV29=window.ByMeliConnectedV44;
  window.ByMeliConnectedV28=window.ByMeliConnectedV44;
  window.ByMeliConnectedV27=window.ByMeliConnectedV44;
  window.ByMeliConnectedV26=window.ByMeliConnectedV44;
  window.ByMeliConnectedV25=window.ByMeliConnectedV44;
  window.ByMeliConnectedV24=window.ByMeliConnectedV44;
  window.ByMeliConnectedV20=window.ByMeliConnectedV44;
