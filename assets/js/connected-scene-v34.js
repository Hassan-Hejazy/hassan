(function(){
  ...
  window.ByMeliConnectedV34={forceInit:queueInit,dispose:()=>disposeConnected(true),auditAt,renderAt,getState:()=>({initialized,progress,target:targetProgress,state:timeline(progress),profile:profile?{w:profile.w,h:profile.h,tier:profile.tier,pixelRatio:renderRatio,ultraRatio:maxRenderRatio,motionRatio:motionRenderRatio,qualityState}:null})};
  window.ByMeliConnectedV33=window.ByMeliConnectedV34;
  window.ByMeliConnectedV32=window.ByMeliConnectedV34;
  window.ByMeliConnectedV31=window.ByMeliConnectedV34;
  window.ByMeliConnectedV30=window.ByMeliConnectedV34;
  window.ByMeliConnectedV29=window.ByMeliConnectedV34;
  window.ByMeliConnectedV28=window.ByMeliConnectedV34;
  window.ByMeliConnectedV27=window.ByMeliConnectedV34;
  window.ByMeliConnectedV26=window.ByMeliConnectedV34;
  window.ByMeliConnectedV25=window.ByMeliConnectedV34;
  window.ByMeliConnectedV24=window.ByMeliConnectedV34;
  window.ByMeliConnectedV20=window.ByMeliConnectedV34;
