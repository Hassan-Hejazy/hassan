(function(){
  ...
  function getProfile(){
    ...
    let fov=32.2;
    if(compact)fov=landscape?32.8:(portrait?31.6:32.2);
    else if(tablet)fov=33.0;
  ...
  function qualityTargets(p){
    ...
    if(p.compact){
      ...
      motionPixels=p.high?2450000:(p.low?1050000:1750000);
      ultraPixels=p.high?6600000:(p.low?2350000:4500000);
      motionCap=p.high?2.42:(p.low?1.56:2.06);
      ultraCap=p.high?3.12:(p.low?2.00:2.76);
      minRatio=p.low?1.14:1.46;
    }else if(p.tablet){
  ...
  const SERVICE_RELATIVE_YAW=[.34,.16,.24,.22,.18,.28];
  ...
  function configureOverview(){
    if(profile.compact&&profile.portrait){
      overviewPositions=[
        new THREE.Vector3(-4.55,0,6.90),new THREE.Vector3(4.55,0,6.90),
        new THREE.Vector3(-4.55,0,0),new THREE.Vector3(4.55,0,0),
        new THREE.Vector3(-4.55,0,-6.90),new THREE.Vector3(4.55,0,-6.90)
      ];
    }else if(profile.tablet||profile.w<1250){
      overviewPositions=[
        new THREE.Vector3(-5.30,0,6.25),new THREE.Vector3(5.30,0,6.25),
        new THREE.Vector3(-5.30,0,0),new THREE.Vector3(5.30,0,0),
        new THREE.Vector3(-5.30,0,-6.25),new THREE.Vector3(5.30,0,-6.25)
      ];
    }else{
      overviewPositions=[
        new THREE.Vector3(-7.40,0,5.40),new THREE.Vector3(0,0,5.70),new THREE.Vector3(7.40,0,5.40),
        new THREE.Vector3(-7.40,0,-5.40),new THREE.Vector3(0,0,-5.70),new THREE.Vector3(7.40,0,-5.40)
      ];
    }
    updateOverviewLinks();
  ...
  function buildLuxuryStudio(){
    ...
    if(Q)Q.addContactShadow(studio,renderer,profile.compact?9.6:12.0,profile.compact?.34:.38,.014);
  }
  ...
  function stageYaw(i){const base=(stationRotations[i]||stagePreset(i).yaw);const lead=profile.compact?(profile.portrait?.03:.04):(profile.tablet?.05:.06);return base-lead;}

  function stageElevation(i){ return stagePreset(i).elev-(profile.compact?(profile.portrait?.030:.022):(profile.tablet?.012:.010)); }

  function stageComposition(i){ const p=stagePreset(i);return {x:0,y:p.compY+(profile.compact?(profile.portrait?-.120:-.070):.014)}; }
  ...
  function holdPose(i,u){
    ...
    const orbit=profile.compact?.004:.010;
    ...
    const pose=framedPose(box,yaw,elev,profile.fov,profile.compact?.0015:.007,stageComposition(i),focus);
  ...
  function transitionLayout(i,q){
    ...
    const shift=i===3?(profile.compact?.08:.16):(profile.compact?.16:.30);
    const depth=profile.compact?.05:.10;
    return {
  ...
  function bridgePose(i,q){
    ...
    const side=i%2?-1:1;
    pos.y+=Math.sin(Math.PI*t)*(profile.compact?.08:.14);
    pos.x+=Math.sin(Math.PI*t)*side*(profile.compact?.04:.08);
    pos.z+=Math.sin(Math.PI*t)*(profile.compact?.06:.10);
  ...
  function finalOverviewScale(){
    if(profile.compact&&profile.portrait)return .34;
    if(profile.compact)return .37;
    if(profile.tablet||profile.w<1250)return .39;
    return .42;
  }
  ...
  function finalOverviewPose(){
    ...
    const yaw=portrait?0.0:(twoColumn?.020:.10);
    const elev=portrait?.84:(twoColumn?.70:(profile.compact?.58:.52));
    const fov=portrait?(profile.fov+2.0):(twoColumn?(profile.fov+1.3):(profile.fov+.5));
    return framedPose(union,yaw,elev,fov,portrait?.016:(twoColumn?.020:.018),{x:0,y:portrait?.012:.008});
  }
  ...
  function queueInit(){
    ...
    setTimeout(()=>{
      ...
      try{init();}
        ...
        console.error('[By Meli] Connected V46 failed:',error);
  ...
  window.ByMeliConnectedV46={forceInit:queueInit,dispose:()=>disposeConnected(true),auditAt,renderAt,getState:()=>({initialized,progress,target:targetProgress,state:timeline(progress),startupMs:initReadyAt&&initStartedAt?initReadyAt-initStartedAt:null,visible,rafActive:Boolean(rafId),pageVisible,profile:profile?{w:profile.w,h:profile.h,tier:profile.tier,pixelRatio:renderRatio,ultraRatio:maxRenderRatio,motionRatio:motionRenderRatio,qualityState}:null})};
  window.ByMeliConnectedV45=window.ByMeliConnectedV46;
  window.ByMeliConnectedV44=window.ByMeliConnectedV46;
  window.ByMeliConnectedV43=window.ByMeliConnectedV46;
  window.ByMeliConnectedV42=window.ByMeliConnectedV46;
  window.ByMeliConnectedV41=window.ByMeliConnectedV46;
  window.ByMeliConnectedV40=window.ByMeliConnectedV46;
  window.ByMeliConnectedV39=window.ByMeliConnectedV46;
  window.ByMeliConnectedV38=window.ByMeliConnectedV46;
  window.ByMeliConnectedV37=window.ByMeliConnectedV46;
  window.ByMeliConnectedV36=window.ByMeliConnectedV46;
  window.ByMeliConnectedV35=window.ByMeliConnectedV46;
  window.ByMeliConnectedV34=window.ByMeliConnectedV46;
  window.ByMeliConnectedV33=window.ByMeliConnectedV46;
  window.ByMeliConnectedV32=window.ByMeliConnectedV46;
  window.ByMeliConnectedV31=window.ByMeliConnectedV46;
  window.ByMeliConnectedV30=window.ByMeliConnectedV46;
  window.ByMeliConnectedV29=window.ByMeliConnectedV46;
  window.ByMeliConnectedV28=window.ByMeliConnectedV46;
  window.ByMeliConnectedV27=window.ByMeliConnectedV46;
  window.ByMeliConnectedV26=window.ByMeliConnectedV46;
  window.ByMeliConnectedV25=window.ByMeliConnectedV46;
  window.ByMeliConnectedV24=window.ByMeliConnectedV46;
  window.ByMeliConnectedV20=window.ByMeliConnectedV46;
