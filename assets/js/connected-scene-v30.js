(function(){
  ...
  function qualityRatio(p){
    ...
    if(p.compact){
      cap=p.high?2.85:(p.low?1.55:2.35);
      targetWidth=p.landscape?2560:1440;
      targetHeight=2160;
      minRatio=p.low?1.20:1.65;
    }else if(p.tablet){
      cap=p.high?3.00:(p.low?1.70:2.45);
      targetWidth=3200;
      targetHeight=2160;
      minRatio=p.low?1.30:1.75;
    }else{
      cap=p.high?3.20:(p.low?1.80:2.55);
      targetWidth=3840;
      targetHeight=2160;
      minRatio=p.low?1.35:1.85;
    }
  ...
  window.ByMeliConnectedV30={forceInit:queueInit,dispose:()=>disposeConnected(true),auditAt,renderAt,getState:()=>({initialized,progress,target:targetProgress,state:timeline(progress),profile:profile?{w:profile.w,h:profile.h,tier:profile.tier,pixelRatio:renderRatio}:null})};
  window.ByMeliConnectedV29=window.ByMeliConnectedV30;
  window.ByMeliConnectedV28=window.ByMeliConnectedV30;
  window.ByMeliConnectedV27=window.ByMeliConnectedV30;
  window.ByMeliConnectedV26=window.ByMeliConnectedV30;
  window.ByMeliConnectedV25=window.ByMeliConnectedV30;
  window.ByMeliConnectedV24=window.ByMeliConnectedV30;
  window.ByMeliConnectedV20=window.ByMeliConnectedV30;
