(function(){
  ...
  function qualityTargets(p){
    ...
    if(p.compact){
      ...
      motionPixels=p.high?2200000:(p.low?1300000:1750000);
      ...
      motionPixels=p.high?5300000:(p.low?2500000:4050000);
      ...
      motionPixels=p.high?6800000:(p.low?2800000:5000000);
  ...
  function createRenderer(){
    const options={canvas,antialias:true,alpha:false,premultipliedAlpha:false,powerPreference:'high-performance',precision:profile.low?'mediump':'highp',stencil:false,preserveDrawingBuffer:false,depth:true,logarithmicDepthBuffer:false,desynchronized:false,failIfMajorPerformanceCaveat:false};
  ...
  function bindGlobal(){
    ...
    const io=new IntersectionObserver(entries=>{
      ...
      if(visible){
        ...
        // V32 keeps the connected renderer alive when the user scrolls away so
        // returning to the section does not require a fragile WebGL rebuild.
        // Context disposal is now reserved for explicit API calls or context loss.
      }
  ...
  window.ByMeliConnectedV32={forceInit:queueInit,dispose:()=>disposeConnected(true),auditAt,renderAt,getState:()=>({initialized,progress,target:targetProgress,state:timeline(progress),profile:profile?{w:profile.w,h:profile.h,tier:profile.tier,pixelRatio:renderRatio,ultraRatio:maxRenderRatio,motionRatio:motionRenderRatio,qualityState}:null})};
  window.ByMeliConnectedV31=window.ByMeliConnectedV32;
  window.ByMeliConnectedV30=window.ByMeliConnectedV32;
  window.ByMeliConnectedV29=window.ByMeliConnectedV32;
  window.ByMeliConnectedV28=window.ByMeliConnectedV32;
  window.ByMeliConnectedV27=window.ByMeliConnectedV32;
  window.ByMeliConnectedV26=window.ByMeliConnectedV32;
  window.ByMeliConnectedV25=window.ByMeliConnectedV32;
  window.ByMeliConnectedV24=window.ByMeliConnectedV32;
  window.ByMeliConnectedV20=window.ByMeliConnectedV32;
