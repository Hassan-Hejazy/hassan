(function(){
  ...
  function qualityTargets(p){
    ...
    if(p.compact){
      // V39 keeps mobile stable but restores more sharpness than V38.
      cap=p.high?3.25:(p.low?1.75:2.70);
      targetWidth=p.landscape?3440:2160;
      targetHeight=p.landscape?2160:3440;
      ultraPixels=p.high?7600000:(p.low?2600000:5000000);
      motionPixels=p.high?2800000:(p.low?1100000:1900000);
      minRatio=p.low?1.08:1.34;
    }else if(p.tablet){
      cap=p.high?3.18:(p.low?1.90:2.78);
      targetWidth=3440;targetHeight=2160;
      ultraPixels=p.high?8200000:(p.low?3400000:5900000);
      motionPixels=p.high?4000000:(p.low?1800000:2900000);
      minRatio=p.low?1.16:1.38;
    }else{
      cap=p.high?3.22:(p.low?1.92:2.88);
      targetWidth=3840;targetHeight=2160;
      ultraPixels=p.high?10000000:(p.low?4300000:7300000);
      motionPixels=p.high?4500000:(p.low?2300000:3500000);
      minRatio=p.low?1.20:1.48;
    }
  ...
  function makeLiveScreen(i){
    ...
    c.width=profile.compact?(high?1152:(profile.low?640:896)):(high?1792:1408);
  ...
  function makeMicroTexture(kind){
    const size=profile.high?(profile.compact?512:960):(profile.low?288:(profile.compact?384:704));
  ...
  window.ByMeliConnectedV39={forceInit:queueInit,dispose:()=>disposeConnected(true),auditAt,renderAt,getState:()=>({initialized,progress,target:targetProgress,state:timeline(progress),profile:profile?{w:profile.w,h:profile.h,tier:profile.tier,pixelRatio:renderRatio,ultraRatio:maxRenderRatio,motionRatio:motionRenderRatio,qualityState}:null})};
  window.ByMeliConnectedV38=window.ByMeliConnectedV39;
  window.ByMeliConnectedV37=window.ByMeliConnectedV39;
  window.ByMeliConnectedV36=window.ByMeliConnectedV39;
  window.ByMeliConnectedV35=window.ByMeliConnectedV39;
  window.ByMeliConnectedV34=window.ByMeliConnectedV39;
  window.ByMeliConnectedV33=window.ByMeliConnectedV39;
  window.ByMeliConnectedV32=window.ByMeliConnectedV39;
  window.ByMeliConnectedV31=window.ByMeliConnectedV39;
  window.ByMeliConnectedV30=window.ByMeliConnectedV39;
  window.ByMeliConnectedV29=window.ByMeliConnectedV39;
  window.ByMeliConnectedV28=window.ByMeliConnectedV39;
  window.ByMeliConnectedV27=window.ByMeliConnectedV39;
  window.ByMeliConnectedV26=window.ByMeliConnectedV39;
  window.ByMeliConnectedV25=window.ByMeliConnectedV39;
  window.ByMeliConnectedV24=window.ByMeliConnectedV39;
  window.ByMeliConnectedV20=window.ByMeliConnectedV39;
